...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            name="respawn_mavros",
            default_value="false"
        ), #your system configuration. Successful communication between the Cube+ control unit and the jetson nano is indicated by a `High resolution IMU detected` message. If you don't see this message, then MAVROS node and the Cube autopilot are not communicating properly.
        #
        DeclareLaunchArgument(
            name="namespace",
